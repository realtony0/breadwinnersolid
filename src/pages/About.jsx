    ...
    <div className="bg-brand-beige px-5 py-16 text-brand-green md:px-8 md:py-20">
      <div className="mx-auto max-w-3xl space-y-10 text-justify text-[1.1rem] leading-[1.8]">
        <header className="space-y-3 text-center">
          ...
          <h1 className="text-4xl font-bold uppercase">Breadwinner</h1>
        </header>
        <p>
        ...
        <p>
          Breadwinner s’adresse à celles et ceux qui veulent afficher fièrement leurs valeurs : résilience, ambition et élégance. Chaque pièce raconte une histoire de grind, de détermination et de réussite durable.
        </p>
